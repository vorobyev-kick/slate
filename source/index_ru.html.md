...
Параметр | Тип | Обязательный | Описание
--------- | ----------- | ----------- | -----------
isoCode | string | ? | краткое наименование криптовалюты по ISO4217
...
state | integer | ? | Индикатор, показывающий, доступна ли торговля этой криптовалюты на бирже <br/>4 – доступна, <br/>1,2,3 – недоступна)
