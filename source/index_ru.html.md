...
Параметр | Тип | Обязательный | Описание
--------- | ----------- | ----------- | -----------
time | timestamp | Да | Время, на которое отображены данные в формате timestamp в мс
...
isWithdrawEnable | boolean | ? | Индикатор, показывающий, доступен ли вывод (0 – доступен, 1 – недоступен)
isDepositEnable | boolean | ? | Индикатор, показывающий, доступно ли пополнение (0 – доступно, 1 – недоступно)
isExchangeEnable | boolean | ? | Индикатор, показывающий, доступен ли обмен на платформе этой криптовалюты (true – доступно, 1 – недоступно)
isFrozen | boolean | ? | Индикатор, показывающий, доступна ли торговля этой криптовалюты на бирже (false – доступна, true – недоступна)
